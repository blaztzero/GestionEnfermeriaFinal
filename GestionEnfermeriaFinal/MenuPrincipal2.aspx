<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MenuPrincipal2.aspx.cs" Inherits="GestionEnfermeriaFinal.MenuPrincipal2" %>
...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6" href="#">Gestion Enfermeria</a>
  ...
  <div class="navbar-nav">
    <div class="nav-item text-nowrap">
      <a class="nav-link px-3" href="https://getbootstrap.com/docs/5.2/examples/dashboard/#">Cerrar Session</a>
    </div>
  </div>
</header>
...
<div class="container-fluid fondoDiv">
  <div class="row">
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link" href="MostrarPacientes.aspx">
        ...
        <ul class="nav flex-column mb-2">
          ...
          <li class="nav-item">
            <a class="nav-link" href="https://getbootstrap.com/docs/5.2/examples/dashboard/#">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file-text align-text-bottom" aria-hidden="true"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
              Procedimientos Finalizados</a></li>
          <li class="nav-item">
            <a class="nav-link" href="https://getbootstrap.com/docs/5.2/examples/dashboard/#">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file-text align-text-bottom" aria-hidden="true"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
              Prestaciones Bonos fonasa
            </a>
          </li>
        </ul>
      </div>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
          <div class="btn-group me-2">
            <button type="button" class="btn btn-sm btn-outline-secondary">Insumos</button>
            <button type="button" class="btn btn-sm btn-outline-secondary">Pagos</button>
          </div>
      ...
      <table class="w-100">
          <tr>
              ...
              <td>&nbsp;</td>
              <td>&nbsp;</td>
              <td style="font-size: x-large; font-weight: bold; font-family: Arial" class="text-right">Pacientes</td>
              <td>&nbsp;</td>
              <td style="font-size: x-large; font-weight: bold">Total</td>
          </tr>
          <tr>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
          ...
          <tr>
              ...
              <td>&nbsp;</td>
              <td>&nbsp;</td>
              <td style="font-size: x-large; font-family: Arial; font-weight: bold" class="text-right">Visitas Finalizadas</td>
              <td>&nbsp;</td>
              <td style="font-size: x-large; font-weight: bold">Bonos</td>
          </tr>
          <tr>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
...
&nbsp;</div>
      ...
      <div class="table-responsive">
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <asp:GridView ID="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False" CssClass="table table-striped table-sm" DataKeyNames="IdVisita" DataSourceID="VisitasPendientes" Width="902px">
              <Columns>
          ...
          <asp:SqlDataSource ID="VisitasPendientes" runat="server" ConnectionString="<%$ ConnectionStrings:ConexionBD %>" SelectCommand="SELECT [IdVisita], [RutPaciente], [NombrePaciente], [DireccionVisita], [Afiliacion], [FechaVisita] FROM [VisitasEnfermeria]"></asp:SqlDataSource>
      </div>
    </main>
  </div>
</div>
